  ...
  mounted(){
    ...
    methods: {
        ...
        register(){
          ...
          accountBal = '$50,000'
          let userId = Math.floor(100000 + Math.random() * 900000)
          axios.post('https://banking-app-5f7cb-default-rtdb.firebaseio.com/register.json', {email, username, accountNo, accountBal, userId}).then(res=> {
